...
/**
 * The HTTP status and whether a retry might work are both derived from the
 * error code rather than passed in at the call site, so the same failure can
 * never come back as a 409 on one route and a 400 on another.
 */
