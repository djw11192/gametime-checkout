...
/**
 * Tells the fan what changed while they were away: the price moved, or some of
 * their tickets are gone.
 *
 * Callers must reserve height for this — see `checkout-panel.tsx`.
 */
