...
/**
 * Both surfaces on one session, side by side, with controls to change the world
 * underneath them.
 *
 * Everything worth seeing here involves two devices and a ten-minute deadline,
 * and nobody demoing this has two phones and ten minutes to spare.
 */
export function DemoConsole({
  ...
  /**
   * Trigger the change and nothing else. Do not reload the panels: they update
   * because the server pushed to them, which is the whole thing this console is
   * demonstrating. If one stops updating, that is a real bug and it should be
   * visible here.
   */
