...
/**
 * Request contracts. The API validates every inbound body against these; the
 * web app parses every response through the schemas in ./session. One
 * definition, two consumers, no drift between the surfaces.
 */
